...
TICKET_CATEGORY_3D = "0002"
TICKET_CATEGORY_2D = "0002"
# --- NEW: SHOWTIME CONSTRAINTS ---
TARGET_SCREEN_NAME = "SCREEN 2"
TARGET_SHOW_INDEX = 2
...
for row in ["B", "C", "D", "E", "F", "G", "H"]:
    for seat in ["06", "07", "05", "08", "09" ,"10", "03", "04"]:
        ...
        for (row, seat), data in seat_tracker.items():
            ...
            if data["status"] == "READY":
                ...
                if success:
                    ...
                    data["cooldown_until"] = time.time() + 789 # 13 mins 10 secs
                    data["failures"] = 0
                else:
                    data["failures"] += 1
