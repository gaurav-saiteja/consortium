...
DATES = ["20260814"]
VENUE_CODE = "ACAS"
TARGET_TICKET_CATEGORY = "0002" # Hardcoded ticket category applies to all seats here
MAX_RUNTIME_SECONDS = (5 * 3600) + (55 * 60) # 5 hours 55 mins
STATE_FILE = "sniped_state_2.json"

# --- NEW: SHOWTIME CONSTRAINTS ---
TARGET_ATTRIBUTE = "LED SCREEN DOLBY ATMOS" # The screen/attribute to look for
TARGET_TIME_START = "06:00 PM"
TARGET_TIME_END = "08:00 PM"
